...
.Antes de empezar
Para una actualización que no sea de alta disponibilidad, apague la máquina virtual (VM) de herramientas ONTAP y, para una actualización de alta disponibilidad, apague el primer nodo antes de realizar los siguientes cambios en la configuración de la máquina virtual (VM).
...
. En la página principal de la máquina virtual, seleccione *Acciones* > *Editar configuración*
...
. Desde vCenter Server, abra una consola en las herramientas de ONTAP .
. Inicie sesión como usuario de mantenimiento.
. Introduzca *3* para seleccionar el menú de Configuración del Sistema.
...
* En caso de una actualización que no sea de alta disponibilidad, reinicie la máquina virtual de herramientas ONTAP para reflejar los cambios.  En caso de una actualización de HA, reinicie el primer nodo para reflejar los cambios en el nodo.
