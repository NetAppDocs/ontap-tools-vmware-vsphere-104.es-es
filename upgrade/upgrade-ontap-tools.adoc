...
* Ve a la pestaña «Instantáneas» y selecciona el botón *Tomar instantánea*. Toma una instantánea en estado de reposo de la máquina virtual. Consulta https://techdocs.broadcom.com/["Documentación técnica de Broadcom"^] para obtener más detalles.
